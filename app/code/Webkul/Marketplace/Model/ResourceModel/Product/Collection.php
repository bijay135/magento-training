...
class Collection extends AbstractCollection
{
    ...
    protected function _construct()
    {
        $this->_init(
            ...
            'Webkul\Marketplace\Model\ResourceModel\Product'
        );
    ...
    public function joinProductTable()
    {
        ...
        $this->getSelect()->joinRight($productTable.' as main_product', 'main_table.mageproduct_id = main_product.entity_id', $fields);
    }
}
